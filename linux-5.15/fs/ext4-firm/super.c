...
#if !defined(CONFIG_EXT2_FS) && !defined(CONFIG_EXT2_FS_MODULE) && defined(CONFIG_EXT4_FIRM_USE_FOR_EXT2)
...
MODULE_ALIAS_FS("ext3-firm");
MODULE_ALIAS("ext3-firm");
...
#ifdef CONFIG_EXT4_FIRM_FS_POSIX_ACL
