...
sudo $QEMU_DIR/build/qemu-system-x86_64 -smp 8 -m 32G \
	...
	-device nvme,serial=ss00,drive=ss,ctrl_cores=4,len-core_threads=4,core_threads[0]=t0,core_threads[1]=t1,core_threads[2]=t2,core_threads[3]=t3,bind_cpu_from=36,mdts=12 \
