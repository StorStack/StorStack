...
ctrl_cores=4,len-core_threads=4,core_threads[0]=t0,core_threads[1]=t1,core_threads[2]=t2,core_threads[3]=t3,\
len-bind_cpus=4,bind_cpus[0]=1,bind_cpus[1]=2,bind_cpus[2]=3,mdts=12 \
	-object iothread,id=t0 \
	-object iothread,id=t1 \
	-object iothread,id=t2 \
	-object iothread,id=t3 \
